...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Archie_MiSTer.git"
CORE_NAME=(Archie)
...
UPSTREAM_CORE_NAME=(Archie)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Archie.qpf)
COMPILATION_OUTPUT=(output_files/Archie.rbf)
